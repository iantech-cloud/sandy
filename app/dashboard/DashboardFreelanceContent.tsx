...
interface DashboardFreelanceContentProps {
  initialStats: FreelanceStats;
}

export function DashboardFreelanceContent({
  initialStats,
}: DashboardFreelanceContentProps) {
  ...
  const displayStats = [
    ...
    {
      label: 'Total Earned',
      value: isLoading ? '...' : `KES ${(stats?.totalEarned || 0).toLocaleString()}`,
      icon: TrendingUp,
    },
    {
